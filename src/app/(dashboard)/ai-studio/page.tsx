...
const TONE_OPTIONS = [
  { id: "professional", label: "Professional", emoji: "💼", desc: "Polished and business-appropriate" },
  { id: "friendly", label: "Friendly", emoji: "😊", desc: "Warm and approachable" },
  { id: "casual", label: "Casual", emoji: "✌️", desc: "Relaxed and conversational" },
  { id: "formal", label: "Formal", emoji: "🎩", desc: "Corporate and precise" },
  { id: "witty", label: "Witty", emoji: "⚡", desc: "Clever with subtle humor" },
];
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {model.tag && (
                            <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-accent-100 text-accent-700">
                              {model.tag}
                            </span>
                          )}
                        </div>
                      ...
                      <span className="text-[11px] text-neutral-400 font-mono tabular-nums hidden sm:block">
                        {model.speed}
                      </span>
                    </button>
                  );
                ...
                {TONE_OPTIONS.map((tone) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex flex-col items-start gap-1 p-3.5 rounded-lg border text-left transition-all duration-150 ${
                        isSelected
